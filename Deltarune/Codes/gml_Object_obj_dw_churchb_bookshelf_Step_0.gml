...
with (npc2)
{
    if (myinteract == 3)
    {
        global.interact = 1;
        var texts = [];
        array_push(texts, "Giovani ");
        array_push(texts, "e ");
        array_push(texts, "senza ");
        array_push(texts, "meta, ");
        array_push(texts, "dove ");
        array_push(texts, "la ");
        array_push(texts, "foresta ");
        array_push(texts, "crescerebbe, ");
        array_push(texts, "seguiron ");
        array_push(texts, "la ");
        array_push(texts, "coda ");
        array_push(texts, "appuntita. ");
