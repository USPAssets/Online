// Game show censoring check that prevents you from typing bad words
// (not the check that changes a bad word after you type it)
// Changed to also prevent you from typing DIO for profamity
function scr_nameentrybadcheck()
{
    ...
    if (lang == 0)
    {
        ...
        // DIO check
        if (letter[0] == 3 && letter[1] == 8 && letter[2] == 14)
        {
            nextletter = true;
        }
    }
