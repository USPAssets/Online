...
usp_credits[0] = [new scr_credit(["", "-Produzione-"], ["CRefice", "Renard", "Jack Lemon"])];
usp_credits[1] = [new scr_credit(["-Traduzione e Check-"], ["BlueJunimo", "Chrippa", "CRefice", "Daizo", "Jack Lemon", "KnuckleBuckle", "L'Armadio"])];
usp_credits[2] = [new scr_credit(["-Tech e Tools-"], ["CRefice", "Depa", "Renard"]), new scr_credit(["-Grafica-"], ["Jack Lemon", "L'Armadio"])];
usp_credits[3] = [new scr_credit(["-SFX-"], ["CRefice", "L'Armadio"]), new scr_credit(["-Doppiaggio-"], ["CRefice"])];
usp_credits[4] = [new scr_credit(["-Playtesting-"], ["A.CraftDEV", "BetweenShades", "IlGardenz", "KendeRoy", "Samp"]), new scr_credit(["-Discord Server Mods-"], ["Depa", "Vanzzzz"])];
usp_credits[5] = [new scr_credit(["-Sito Web-"], ["Renard"]), new scr_credit(["-Illustrazioni Social-"], ["L'Armadio", "Chrippa", "GiMoody", "Jack Lemon"])];
usp_credits[6] = [new scr_credit(["--Ringraziamenti Speciali--", "-Aiuto Audio-"], ["Gnafu86"]), new scr_credit(["-Possessore di Libro Calvin & Hobbes-"], ["Frazzers"]), new scr_credit(["-Modding Tools-"], ["Team di sviluppo di UndertaleModTool"])];
usp_credits[7] = [new scr_credit([""], ["Questa traduzione è stata fatta da esseri umani."])];
usp_moment = false;
usp_timer = 0;
credits_con = 0;
init = false;
