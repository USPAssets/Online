if (i_ex(obj_tenna_zoom) && (obj_tenna_zoom.minigameinsanityintro || obj_tenna_enemy.phaseturn == 18))
{
    ...
    if (!i_ex(obj_tvturnoff_manager))
        draw_text_color((camerax() + camerawidth()) - 70, cameray() + 10, "Can" + string(_channelnumber), c_lime, c_lime, c_lime, c_lime, 1);
}
...
{
    draw_text_transformed(camerax() + score_x + 140, ((cameray() + bar_y) - 5) + 70, "NEMICO", 3, 2, 0);
...
{
    draw_text_transformed(camerax() + score_x + 120, ((cameray() + bar_y) - 5) + 70, "NEMICO", 3, 2, 0);
...
{
    draw_text_transformed(camerax() + score_x, (cameray() + bar_y) - 5, "NEMICO", 3, 2, 0);
...
draw_text_transformed(camerax() + score_x, cameray() + score_y, "PUNTI", 3, 2, 0);
...
draw_text_transformed_color((camerax() + box_x) - 130, cameray() + box_y + 18, "ERRORI", 3, 2, 0, blend1, blend1, blend1, blend1, 1);
